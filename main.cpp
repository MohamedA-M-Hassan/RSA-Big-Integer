...
int main()
{
	...
	s = "";
	p = "";
	if (s==p)cout << "did it ^_^ " << endl;
	v1.setValue(p);
	v2.setValue(q);
	v3.setValue(m);
	...
	/*v1 =v1.powerOperation(v2,v3);
	v1.print();cout << endl ;
	*/if (v1.equal(v3)) 
		cout << "did itaslkdf " << endl;
