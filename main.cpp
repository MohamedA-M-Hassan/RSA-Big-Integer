...
int main()
{
	...
	// div & mod test case
	/*string numiminator_s = "";
	string denominator_s = "";
	BigNum numiminator(numiminator_s);
	BigNum denominator(denominator_s);
	BigNum result = numiminator.divOperation(denominator);
	result.print();std::cout << endl;
	result = numiminator.modOperation(denominator);
	*/
	int t1=123456789, t2=12;
